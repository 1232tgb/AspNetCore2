...
namespace App2.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Nome,Ano")] Carros carros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Nome,Ano")] Carros carros)
        {
            if (id != carros.Id)
            {
                return NotFound();
